    ...
    <div className="flex h-full">
      ...
      <div className="w-96 border-r border-gray-800 flex flex-col bg-gray-950">
        ...
        <div className="flex-1 overflow-y-auto">
          {loading && <div className="p-4 text-center text-gray-500 text-sm">Loading profiles...</div>}
          ...
          {countries.map(c => (
            <button
              ...
              className={`w-full text-left p-4 border-b border-gray-800 hover:bg-gray-900 transition-colors ${selected?.country_code === c.country_code ? 'bg-gray-900 border-l-2 border-l-blue-500' : ''}`}
            >
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs text-gray-500">{c.event_count_7d} events / 7d</span>
      ...
      <div className="flex-1 overflow-y-auto p-6">
        {!selected ? (
          <div className="flex flex-col items-center justify-center h-full text-gray-500">
            <Shield className="w-12 h-12 mb-3 text-gray-700" />
          ...
          <div className="max-w-3xl space-y-6">
            ...
            <div className="flex items-start justify-between">
              ...
              <div className="text-right text-sm text-gray-500">
                <div className="flex items-center gap-1 text-xs">Conflict: <span className="capitalize font-medium text-gray-300">{selected.conflict_intensity}</span></div>
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-xl p-5">
              <h3 className="font-semibold mb-4 flex items-center gap-2"><TrendingUp className="w-4 h-4 text-orange-400" /> Risk Breakdown</h3>
            ...
            {selected.ai_summary && (
              <div className="bg-blue-950/30 border border-blue-800/30 rounded-xl p-5">
                ...
                <p className="text-xs text-gray-500 mt-3">Updated: {new Date(selected.last_updated).toLocaleString()}</p>
              </div>
            )}
