    ...
    <div className="min-h-screen" style={{ background: '#070B11', color: '#fff' }}>
      ...
      <section className="pt-32 pb-24 px-6 relative">
        ...
        <div className="absolute inset-0 -z-10">
          <div className="absolute top-1/4 left-1/4 w-[600px] h-[400px] bg-purple-600/[0.08] rounded-full blur-[150px]" />
          <div className="absolute bottom-0 right-1/3 w-[500px] h-[400px] bg-blue-600/[0.06] rounded-full blur-[130px]" />
        </div>

        <BlurIn className="max-w-4xl mx-auto text-center relative z-10">
          <p className="text-sm font-bold text-blue-400 tracking-widest uppercase mb-6">Intelligence Methodology</p>
          ...
          <p className="text-lg md:text-xl text-white/45 max-w-3xl mx-auto leading-relaxed">
            Transparent data collection, rigorous scoring, and responsible enrichment. No magic box. Just a well-lit one.
          </p>
        </BlurIn>
      </section>
